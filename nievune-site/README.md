...
## Login social
O botão Google já está incluído. Ative o provedor no Supabase seguindo `setup/SOCIAL_LOGIN_SETUP.txt`. O código de Apple também está preparado, mas permanece oculto até a configuração de uma conta Apple Developer.
