...
(() => {
  ...
  if (cloudMode) {
    ...
    banner.textContent = 'Private manager unavailable — configure Supabase in config.js before using this page.';
    authCard.hidden = false;
    editorCard.hidden = true;
    document.getElementById('authMessage').textContent = 'The public store remains available, but product management is locked until Supabase authentication is configured.';
